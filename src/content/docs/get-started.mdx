...
Get the latest version of the MediaUI package from the VPM Repository (reccommended)

##### [Repository](https://artifishvr.github.io/MediaUI/) 

You can also find releases on [GitHub](https://github.com/artifishvr/MediaUI/releases)

## Setting Up MediaUI in Your VRChat World

Once you have imported the package, you should be able to find it in your project's Packages folder.

<FileTree>

- Assets/
- Packages/
  - MediaUI (gay.arti.mediaui)
    - Runtime/
      - Scripts/
      - UI&nbsp;Assets/
      - **MediaUI.prefab**
...
<Tabs>
  <TabItem label="VizVid">
    Drag these two objects from your VizVid prefab into the respective fields in the NyaResultsManager component, as shown in this picture
