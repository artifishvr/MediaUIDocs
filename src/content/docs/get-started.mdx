...
Download the latest version of the MediaUI package (v0.7.1) and import it into Unity ([tutorial](https://youtu.be/ZYJ7idfeuZQ)).

##### [Download Link](/dl/MediaUI%20v0.7.1.unitypackage) 

You can also find the package on [GitHub](https://github.com/artifishvr/MediaUI)

(A VPM Repository will also be available in the future for easier updates.)
